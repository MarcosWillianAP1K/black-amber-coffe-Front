...
export const API = {
    ...
    AdminProducts: {
        ...
        ActiveProductsByID: (id: string) => `${API_BASE}/admin/products/${id}/active`,
        DesactiveProductsByID: (id: string) => `${API_BASE}/admin/products/${id}/desactive`,
        GetProductsById: (id: string) => `${API_BASE}/admin/products/${id}/stock`,
        UpdateProductsById: (id: string) => `${API_BASE}/admin/products/${id}/stock`,
    },
    Users: {
        Base: `${API_BASE}/user`,
        GetMe: `${API_BASE}/user/get/me`,
        UptadeMe: `${API_BASE}/user/update/me`,
        DeleteMe: `${API_BASE}/user/delete/me`,
    },
    Workers: {
